...
try:
    with open('../../assets/imagebutton_left.png','rb') as f:
...
try:
    with open('../../assets/imagebutton_mid.png','rb') as f:
...
try:
    with open('../../assets/imagebutton_right.png','rb') as f:
        imagebutton_right_data = f.read()
except:
    print("Could not find imagebutton_right.png")
    sys.exit()
...
imagebutton1 = lv.imagebutton(lv.scr_act())
